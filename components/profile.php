    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-surface rounded-2xl shadow-card p-8 mb-8 transition-all duration-300">
            <div class="flex flex-col md:flex-row items-start gap-8">
                <!-- Avatar -->
                <div class="w-32 h-32 relative group rounded-full overflow-hidden bg-primary flex items-center justify-center shadow-lg border-4 border-white">
                    <img id="profile-avatar" src="/placeholder.svg" alt="User Avatar" class="w-full h-full object-cover">
                    <button onclick="openAvatarModal()" class="absolute opacity-0 group-hover:opacity-100 inset-0 bg-black bg-opacity-50 flex items-center justify-center transition-opacity duration-300">
                ...
                <div class="flex-1">
                    <div class="flex flex-col md:flex-row md:items-center gap-4 mb-4">
                        ...
                        <button onclick="logout()" class="md:ml-auto bg-error hover:bg-red-600 text-white px-6 py-2.5 rounded-lg transition-colors duration-300 flex items-center gap-2 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                        ...
                        <div class="bg-success/10 px-6 py-4 rounded-xl flex items-center gap-4 card-hover">
                            ...
                            <div>
                                <span class="text-success text-2xl font-bold"><?php echo $completion_percentage; ?>%</span>
                        ...
                        <div class="bg-warning/10 px-6 py-4 rounded-xl flex items-center gap-4 card-hover">
                            ...
                            <div>
                                <span class="text-warning text-2xl font-bold"><?php echo count($currentCourses); ?></span>
        ...
        <div class="bg-surface rounded-2xl shadow-card p-8 mb-8 transition-all duration-300">
            ...
            <?php else: ?>
                <div class="relative">
                    ...
                    <div class="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-<?php echo min(count($journeyPoints), 5); ?> gap-8 py-8">
                        <?php
        ...
        <div class="bg-surface rounded-2xl shadow-card p-8 transition-all duration-300">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="category" class="text-primary hover:text-primary-dark flex items-center gap-1 transition-colors">
            ...
            <?php if (empty($currentCourses)): ?>
                <div class="text-center py-10 bg-gray-50 rounded-xl">
                    ...
                    <a href="/courses" class="inline-block bg-primary hover:bg-primary-dark text-white px-6 py-2 rounded-lg transition-colors">
                        Explore Courses
                    </a>
                </div>
            <?php else: ?>
...
<script>
    ...
    <div id="avatar-modal" class="fixed inset-0 bg-black bg-opacity-50 flex z-50 items-center justify-center hidden backdrop-blur-sm">
        <div class="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full transform transition-all duration-300">
            ...
            <div class="mt-6 flex justify-end">
                <button onclick="closeAvatarModal()" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg mr-2 transition-colors">
                    Cancel
                </button>
                <button id="save-avatar" class="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-lg transition-colors">
                    Save Selection
                </button>
            </div>
        </div>
