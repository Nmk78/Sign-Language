...
<body class="bg-gray-100 font-sans">
    ...
    <div class="fixed bottom-6 right-6 z-50">
        <button id="chatIcon" class="w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-blue-600 transition-colors duration-300 focus:outline-none">
    ...
    <!-- Chat Box -->
    <div id="chatBox" class="<?php echo $chatOpen ? '' : 'hidden'; ?> fixed bottom-20 right-6 w-96 bg-white shadow-2xl rounded-lg overflow-hidden transition-all duration-300 transform scale-95 opacity-0">
